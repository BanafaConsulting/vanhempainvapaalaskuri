...
// TODO: korjaa lopetuspäivämäärä pyhän tai viikonlopun loppuun TODO: keksi parempi tapa huomioda 0-päivät
...
/*
    ...
    patLeaveOneEnd = moment(countForward(birthDate, patLeaveDaysWithMother));
    ...
    patLeaveTwoBegin = moment(countForward(parLeaveFatherEnd, 2)); // lasketaan  isyysvapaan toisen osan aloitus alkamaan isän vanhempainvapaapäivien jälkeen. Kaksi päivää, koska laskentafunktio vähentää loppupäivästä yhden päivän.
    patLeaveTwoEnd = moment(countForward(patLeaveTwoBegin, patLeaveDaysAlone)); // lasketaan isyysvapaan toisen osan päättymispäivä
...
/* TÄMÄN JÄLKEEN KAIKKI TURHA KOODI
...
$("#aitysvapaanAloitusMin").text(matLeaveBeginMin.format("D.M.Y")); // äitiysvapaanaloitus aikaisintaan
$("#aitysvapaanAloitusMax").text(matLeaveBeginMax.format("D.M.Y")); // äitiysvapaanaloitus viimeistään
